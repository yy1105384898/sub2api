export default {
  ...
  admin: {
    ...
    relayMonitor: {
      title: '中转站监控',
      description: '抓取外部中转站（sub2api / newapi）的分组倍率，记录涨跌变化',
      tabCompare: '比价',
      tabOverview: '站点总览',
      tabChanges: '变化公告',
      tabSites: '站点管理',
      compareTitle: '同档套餐比价',
      compareHint: '按「厂商·套餐」归类，组内各站点按当前倍率从低到高排序，🏆 为当前最低价。',
      bucketsUnit: '个档位',
      quotesUnit: '个报价',
      cheapest: '当前最低价',
      kpiSites: '监控站点',
      ...
      viewHistory: '查看倍率历史',
      historyTitle: '倍率历史',
      noHistory: '该分组暂无倍率变化历史',
      upAnnouncements: '涨公告',
      downAnnouncements: '跌公告',
      lastRefresh: '最近刷新',
      filterTitle: '公告筛选',
      legendUp: '红色代表涨',
      legendSep: '，',
      ...
      noChange: '无变化',
      noChanges: '暂无倍率变化记录',
      noOverview: '暂无数据，先在「站点管理」加站点并探测',
      colName: '名称',
      colBaseUrl: '站点地址',
      colWatched: '监控分组',
      colInterval: '间隔',
      ...
      editSite: '编辑站点',
      probe: '探测',
      noSites: '暂无监控站点，点击“新增站点”开始',
      noGroupSelected: '未选择分组',
      credential: '访问凭证',
      authMethod: '认证方式',
      authModePassword: '账号密码',
      authModeToken: '直接填 Token',
      tokenLabel: '访问 Token (JWT)',
      tokenHint: '适用开了人机验证(Turnstile)、无法自动登录的站：在浏览器登录目标站后，从开发者工具/接口里复制 access_token 粘到这里；token 过期后需重新填。',
      authAccount: '登录邮箱',
      ...
      credentialOptional: '(newapi 可留空)',
      credentialKeep: '留空则保持原密码',
      watchedGroups: '监控分组',
      watchedGroupsHint: '只监控勾选的分组倍率；先“拉取分组列表”再勾选',
      autoProbeCategories: '自动探测类型',
      autoProbeAll: '全部分组（含新增）',
      autoProbeDomestic: '国产模型',
      newGroup: '新增',
      fetchGroups: '拉取分组列表',
      fetching: '拉取中…',
      noGroupsFetched: '尚未拉取到分组，请先填好地址与凭证后点击拉取',
      enableProbing: '启用定时探测',
      ...
      deleteGroupTitle: '删除停用分组',
      deleteGroupConfirm: '确定删除「{site} / {group}」这个停用分组吗？后续如果上游重新出现且匹配自动探测类型，会再次收录。',
      loadError: '加载失败',
      probeFailed: '探测失败',
      fetchGroupsFailed: '拉取分组失败',
      probeAllDone: '已探测 {n} 个站点',
      probeOneDone: '探测完成，检测到 {n} 处变化',
    },
    ...
    accounts: {
      ...
      dataImportMultiHint: 'JSON (.json)，支持多选或选择整个文件夹批量导入',
      dataImportChooseFiles: '选择文件',
      dataImportChooseFolder: '选择文件夹',
      dataImportFileCount: '已选 {count} 个 JSON 文件',
