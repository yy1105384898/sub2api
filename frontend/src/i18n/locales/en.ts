export default {
  ...
  admin: {
    ...
    relayMonitor: {
      title: 'Relay Monitor',
      description: 'Track external relay stations (sub2api / newapi) group rate multipliers and record changes',
      tabCompare: 'Compare',
      tabOverview: 'By Site',
      tabChanges: 'Changes',
      tabSites: 'Sites',
      compareTitle: 'Price Compare',
      compareHint: 'Grouped by vendor·plan; sites sorted by current rate ascending, 🏆 is the cheapest.',
      bucketsUnit: 'buckets',
      quotesUnit: 'quotes',
      cheapest: 'Cheapest',
      kpiSites: 'Sites',
      kpiGroups: 'Groups',
      sortRateAsc: 'Rate low→high',
      sortRateDesc: 'Rate high→low',
      sortChange: 'By change',
      pin: 'Pin',
      unpin: 'Unpin',
      viewHistory: 'View rate history',
      historyTitle: 'Rate History',
      noHistory: 'No rate change history for this group yet',
      upAnnouncements: 'Up Announcements',
      downAnnouncements: 'Down Announcements',
      lastRefresh: 'Last Refresh',
      filterTitle: 'Filter',
      legendUp: 'Red = up',
      legendSep: ', ',
      legendDown: 'green = down.',
      ...
      filterHint: 'Grouped by site first, then by vendor and plan inside each site.',
      clearFilters: 'Clear',
      probeAll: 'Probe All',
      probing: 'Probing…',
      up: 'Up',
      ...
      colChange: 'Change',
      colChangedAt: 'Last Change',
      colTime: 'Time',
      colContent: 'Content',
      noChange: 'No change',
      noChanges: 'No rate changes recorded yet',
      noOverview: 'No data yet. Add a site under "Sites" and probe.',
      colName: 'Name',
      colBaseUrl: 'Base URL',
      colWatched: 'Watched Groups',
      colInterval: 'Interval',
      colEnabled: 'Enabled',
      colLastChecked: 'Last Probed',
      colActions: 'Actions',
      addSite: 'Add Site',
      editSite: 'Edit Site',
      probe: 'Probe',
      noSites: 'No sites yet. Click "Add Site" to start',
      noGroupSelected: 'No group selected',
      credential: 'Credential',
      authMethod: 'Auth method',
      authModePassword: 'Email & password',
      authModeToken: 'Paste token',
      tokenLabel: 'Access Token (JWT)',
      tokenHint: 'For sites with Turnstile/captcha that block auto-login: log into the target site in a browser, copy the access_token from devtools and paste it here; re-paste when it expires.',
      ...
      credentialOptional: '(optional for newapi)',
      credentialKeep: 'Leave blank to keep current',
      watchedGroups: 'Watched Groups',
      watchedGroupsHint: 'Only the selected groups are tracked. Fetch the group list first, then pick.',
      autoProbeCategories: 'Auto Probe Types',
      autoProbeAll: 'All groups (incl. new)',
      autoProbeDomestic: 'Domestic models',
      newGroup: 'New',
      fetchGroups: 'Fetch Groups',
      fetching: 'Fetching…',
      noGroupsFetched: 'No groups fetched yet. Fill base URL & credential then fetch.',
      enableProbing: 'Enable scheduled probing',
      ...
      deleteGroupTitle: 'Delete Disabled Group',
      deleteGroupConfirm: 'Delete disabled group "{site} / {group}"? If it appears upstream again and matches auto probe types, it will be collected again.',
    ...
    accounts: {
      ...
      dataImportMultiHint: 'JSON (.json) — pick multiple files or a whole folder to bulk import',
      dataImportChooseFiles: 'Choose files',
      dataImportChooseFolder: 'Choose folder',
      dataImportFileCount: '{count} JSON files selected',
