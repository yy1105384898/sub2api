...
// The RelayMonitorFunc type is an adapter to allow the use of ordinary function as a Querier.
type RelayMonitorFunc func(context.Context, *ent.RelayMonitorQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f RelayMonitorFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.RelayMonitorQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.RelayMonitorQuery", q)
}

// The TraverseRelayMonitor type is an adapter to allow the use of ordinary function as Traverser.
type TraverseRelayMonitor func(context.Context, *ent.RelayMonitorQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseRelayMonitor) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseRelayMonitor) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.RelayMonitorQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.RelayMonitorQuery", q)
}

// The RelayRateChangeFunc type is an adapter to allow the use of ordinary function as a Querier.
type RelayRateChangeFunc func(context.Context, *ent.RelayRateChangeQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f RelayRateChangeFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.RelayRateChangeQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.RelayRateChangeQuery", q)
}

// The TraverseRelayRateChange type is an adapter to allow the use of ordinary function as Traverser.
type TraverseRelayRateChange func(context.Context, *ent.RelayRateChangeQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseRelayRateChange) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseRelayRateChange) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.RelayRateChangeQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.RelayRateChangeQuery", q)
}

// The RelayRateSnapshotFunc type is an adapter to allow the use of ordinary function as a Querier.
type RelayRateSnapshotFunc func(context.Context, *ent.RelayRateSnapshotQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f RelayRateSnapshotFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.RelayRateSnapshotQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.RelayRateSnapshotQuery", q)
}

// The TraverseRelayRateSnapshot type is an adapter to allow the use of ordinary function as Traverser.
type TraverseRelayRateSnapshot func(context.Context, *ent.RelayRateSnapshotQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseRelayRateSnapshot) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseRelayRateSnapshot) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.RelayRateSnapshotQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.RelayRateSnapshotQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.RelayMonitorQuery:
		return &query[*ent.RelayMonitorQuery, predicate.RelayMonitor, relaymonitor.OrderOption]{typ: ent.TypeRelayMonitor, tq: q}, nil
	case *ent.RelayRateChangeQuery:
		return &query[*ent.RelayRateChangeQuery, predicate.RelayRateChange, relayratechange.OrderOption]{typ: ent.TypeRelayRateChange, tq: q}, nil
	case *ent.RelayRateSnapshotQuery:
		return &query[*ent.RelayRateSnapshotQuery, predicate.RelayRateSnapshot, relayratesnapshot.OrderOption]{typ: ent.TypeRelayRateSnapshot, tq: q}, nil
